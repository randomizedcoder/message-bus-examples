# nix/gitops/env/monitoring/dashboards/soak.nix
#
# The hand-written "Message-bus Soak" Grafana dashboard (infra + soak-client
# panels), provisioned as a ConfigMap the Grafana file-provider loads from
# /etc/grafana/dashboards/soak. Split out of the old monolithic monitoring.nix
